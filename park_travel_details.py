...
class ParkTravelDetails:
    ...
    def get_distance(self) -> float:
        miles_distance_str = self.distance_matrix_response_json['rows'][0]['elements'][0]['distance']['text']
        miles_distance_float = float(miles_distance_str.split(" ")[0])
        return miles_distance_float
